...
$aliases['prod'] = array(
  'uri' => 'www.adas.com',
  'root' => '/var/www/regarden.com/www/public_html',
  'os' => 'Linux',
  /*'remote-host' => 'server.regarden.com',*/
  'remote-host' => 'ip',
  'remote-user' => 'regarden',
  /*'databases' =>
    array (
      'default' =>
        array (
  ...
  'path-aliases' => array(
    ...
    '%drush-script' => '/home/regarden/.config/composer/vendor/bin/drush'
  ),
  'command-specific' =>
    array (
    'sql-sync' => array (
      'sanitize' => false,
      'structure-tables' => array ('common' => array (
        'cache_bootstrap',
        'cache_config',
        'cache_container',
        'cache_data',
...
$aliases['stage'] = array(
  'uri' => 'stage.regarden.com',
  'root' => '/var/www/regarden.com/stage/public_html',
  'os' => 'Linux',
  /*'remote-host' => 'server.regarden.com',*/
  'remote-host' => '95.216.156.239',  
  'remote-user' => 'regarden',
  /*'databases' =>
    array (
      'default' =>
...
$aliases['dev'] = array(
  'uri' => 'ongea.fermicoding.com',
  'root' => '/var/www/html/ongea/dev/web',
  'os' => 'Linux',
  'remote-host' => 'server.fermicoding.com',
  'remote-user' => 'fermi',
  /*'databases' =>
    array (
      'default' =>
...
$aliases['loc'] = array (
  'uri' => 'ongea',
  'root' => '/home/fermid/1/public_html/de/ongea/web',
  'os' => 'Linux',
/*  'databases' =>
    array (
      'default' =>
...
//shortcuti za sinhronizaciju fajlova
//usage: drush @loc dl
// kopiraju se samo novi fajlovi ili ako je timestamp na source veci nego na destnation
//$options['shell-aliases']['ds'] = '!ssh regarden@95.216.156.239 /home/regarden/deploy.sh files '.$aliases['dev']['root'].' '.$aliases['stage']['root'];
//$options['shell-aliases']['sp'] = '!ssh regarden@95.216.156.239 /home/regarden/deploy.sh files '.$aliases['stage']['root'].' '.$aliases['prod']['root'];


//usage: drush @loc fdl
// kopiraju se samo novi fajlovi ili ako je timestamp na source veci nego na destnation
//$options['shell-aliases']['fpd'] = '!ssh regarden@95.216.156.239 /home/regarden/deploy.sh files ' . $aliases['prod']['root'] . '/' . $aliases['prod']['path-aliases']['%files'] . ' ' . $aliases['dev']['root'] . '/' . $aliases['dev']['path-aliases']['%files'];
//$options['shell-aliases']['fpl'] = 'rsync @prod:%files/ @loc:%files';
//$options['shell-aliases']['fdp'] = '!ssh regarden@95.216.156.239 /home/regarden/deploy.sh files ' . $aliases['dev']['root'] . '/' . $aliases['dev']['path-aliases']['%files'] . ' ' . $aliases['prod']['root'] . '/' . $aliases['prod']['path-aliases']['%files'];
//$options['shell-aliases']['fsp'] = '!ssh regarden@95.216.156.239 /home/regarden/deploy.sh files ' . $aliases['stage']['root'] . '/' . $aliases['stage']['path-aliases']['%files'] . ' ' . $aliases['prod']['root'] . '/' . $aliases['prod']['path-aliases']['%files'];
$options['shell-aliases']['fdl'] = 'rsync @dev:%files/ @loc:%files';
//$options['shell-aliases']['flp'] = 'rsync @loc:%files/ @prod:%files';
//$options['shell-aliases']['fls'] = 'rsync @loc:%files/ @stage:%files';
$options['shell-aliases']['fld'] = 'rsync @loc:%files/ @dev:%files';



//shortcuti za sinhronizaciju baze
//usage: drush @loc sdl
//$options['shell-aliases']['sps'] = '!drush sql-sync @prod @stage';
//$options['shell-aliases']['spd'] = '!drush sql-sync @prod @dev';
//$options['shell-aliases']['spl'] = '!drush sql-sync @prod @loc';
//$options['shell-aliases']['ssd'] = '!drush sql-sync @stage @dev';
//$options['shell-aliases']['ssl'] = '!drush sql-sync @stage @loc';
//$options['shell-aliases']['sdp'] = 'sql-sync @dev @prod';
//$options['shell-aliases']['sds'] = '!drush sql-sync @dev @stage';
$options['shell-aliases']['sdl'] = '!drush sql-sync @dev @loc';
$options['shell-aliases']['sld'] = '!drush sql-sync @loc @dev';
//$options['shell-aliases']['sls'] = '!drush sql-sync @loc @stage';
//$options['shell-aliases']['slp'] = 'sql-sync @loc @prod';
