 ...
 *
 * @RestResource(
 *   id = "organisations_entity_resource",
 *   label = @Translation("Ongea Organisations Resource"),
 *   uri_paths = {
 *     "canonical" = "/api/v2/organisations/{id}",
 *     "create" = "/api/v2/organisations/{id}"
 *   }
 *
 * )
 */
class OrganisationsEntityResource extends EntityResourceBase
{
