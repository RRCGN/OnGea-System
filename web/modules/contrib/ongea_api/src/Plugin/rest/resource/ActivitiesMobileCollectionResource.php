 ...
 *
 * @RestResource(
 *   id = "activities_mobile_collection_resource",
 *   label = @Translation("Ongea Mobile Activities Resource - Depricated"),
 *   uri_paths = {
 *     "canonical" = "/api/a3/activities",
 *     "https://www.drupal.org/link-relations/create" = "/api/a3/activities"
 *   }
 *
 * )
 */
class ActivitiesMobileCollectionResource extends CollectionResourceBase
{
