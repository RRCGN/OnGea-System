...
var Editor = withStyles(styles$19, { name: 'Editor' })(EditorBase);

var styles$20 = function styles$$1(_ref) {
  var spacing = _ref.spacing;
  return {
    icon: {
...
var FilterSelector = withStyles(styles$20, { name: 'FilterSelector' })(FilterSelectorBase);
...
var GroupingControl = withStyles(styles$22, { name: 'GroupingControl' })(GroupingControlBase);
...
var ResizingControl = withStyles(styles$23, { name: 'ResizingControl' })(ResizingControlBase);
...
var SortingControl = withStyles(styles$24, { name: 'SortingControl' })(SortingControlBase);
...
var TableHeaderCell = withStyles(styles$21, { name: 'TableHeaderCell' })(TableHeaderCellBase);
...
var Cell = withStyles(styles$25, { name: 'Cell' })(CellBase);
...
var BandedHeaderCell = withStyles(styles$26, { name: 'BandedHeaderCell' })(BandedHeaderCellBase);
...
var InvisibleCell = withStyles(styles$27, { name: 'InvisibleCell' })(InvisibleCellBase);
...
var Row = withStyles(styles$28, { name: 'Row' })(RowBase);
...
var EditCell = withStyles(styles$29, { name: 'EditCell' })(EditCellBase);
...
var withEditColumnStyles = withStyles(styles$30, { name: 'EditColumn' });
...
var EmptyMessage = withStyles(styles$31, { name: 'EmptyMessage' })(EmptyMessageBase);
...
var Toolbar$3 = withStyles(styles$32, { name: 'Toolbar' })(ToolbarBase);
...
var TableTreeExpandButton = withStyles(styles$33)(TableTreeExpandButtonBase);
...
var TableTreeCheckbox = withStyles(styles$34)(TableTreeCheckboxBase);
...
var TableTreeIndent = withStyles(styles$35)(TableTreeIndentBase);

var styles$36 = function styles$$1() {
  return {
    content: {
      width: '100%',
      overflow: 'hidden',
...
var TableTreeContent = withStyles(styles$36)(TableTreeContentBase);
...
var TableTreeCell = withStyles(styles$37)(TableTreeCellBase);
...
var SearchPanelInput = withStyles(styles$38)(SearchPanelInputBase);
