...
namespace Drupal\ongea_channel\Configuration;
...
/**
 * Class OngeaChannelConfigOverride.
 *
 * @package Drupal\ongea_channel
 */
class OngeaChannelSettingsOverride implements ConfigFactoryOverrideInterface
{
    ...
    public function loadOverrides($names)
    {
        ...
        if (in_array('system.site', $names)) {
            ...
            if (!empty($domain)) {
                ...
                $configFactory = $this->configFactory->get('ongea_channel.ongeaconfigsettings');
    ...
    {
        return 'MultiSiteOngeaConfigurationOverrider';
    }
