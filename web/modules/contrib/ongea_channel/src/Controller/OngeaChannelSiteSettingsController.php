...
namespace Drupal\ongea_channel\Controller;
...
/**
 * Class OngeaChannelSiteSettingsController.
 *
 * @package Drupal\ongea_channel\Controller
 */
class OngeaChannelSiteSettingsController extends ControllerBase {
  ...
  public function domainList() {
    ...
    foreach ($domains as $domain) {
      $row = [
        $domain->label(),
        $domain->id(),
        Link::fromTextAndUrl($this->t('Edit'), Url::fromRoute('ongea_channel.config_form', array('domain_id' => $domain->id()))),
      ];
      $rows[] = $row;
    }
